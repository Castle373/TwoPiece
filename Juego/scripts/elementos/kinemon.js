export default class Kinemon {
    ...
    create(x,y) {
        ...
        this.sprite = this.scene.physics.add.sprite(x,y, 'kinemon', 0).setScale(1);
        ...
        this.sprite.play('kinemonparado'); // Reproduce la animación inicial
    }

    createAnimations() {
        const animsData = this.scene.cache.json.get('kinemonAnims');
